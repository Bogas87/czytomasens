...
export function PremiumReport({
  ...
  return (
    <div className="ctms-report ctms-report-prestige">
      ...
      <Surface className="ctms-report-essence">
        <div className="ctms-report-essence-index">01</div>
        <div>
      ...
      <section className="ctms-report-grid">
        <ListCard title="02 · CO DZIŚ WIEMY" items={report.whatWeKnow} />
        <ListCard title="03 · CZEGO JESZCZE NIE WIEMY" items={report.unknowns} />
      </section>
      ...
      <Surface className="ctms-report-section ctms-blind-spot">
        <Kicker>07 · MOŻLIWY ŚLEPY PUNKT</Kicker>
      ...
      <Surface className="ctms-burden">
        <div>
          <Kicker>08 · PROFIL OBCIĄŻENIA</Kicker>
      ...
      <Surface className="ctms-report-section">
        <div className="ctms-section-head">
          <Kicker>09 · GRANICE I KRYTERIA</Kicker>
      ...
      <ListCard title="10 · CO MOŻE ZMIENIĆ OCENĘ" items={report.changeConditions} />

      {report.safety.protocolAllowed ? (
        <Surface className="ctms-protocol">
          <div className="ctms-section-head">
            <Kicker>11 · SPRAWDZENIE W RZECZYWISTOŚCI</Kicker>
