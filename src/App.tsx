...
const CONSENTS = [
  "Rozumiem, że CzyToMaSens jest narzędziem analitycznym i refleksyjnym, a nie poradą psychologiczną, terapeutyczną, medyczną ani prawną.",
  "Rozumiem, że wynik i raport powstają na podstawie moich odpowiedzi i nie stanowią diagnozy ani oceny drugiej osoby.",
  "Akceptuję Regulamin oraz Politykę prywatności i RODO.",
  "Przed zakupem pełnego raportu potwierdzam zgodę na rozpoczęcie realizacji treści cyfrowej i przyjmuję do wiadomości utratę prawa odstąpienia po rozpoczęciu generowania raportu.",
];

const LEGAL_CONTENT: Record<Exclude<LegalKey, null>, { title: string; body: string }> = {
  regulamin: {
    title: "Regulamin",
    body: `Data obowiązywania: 21.05.2026 r.\n\n1. Informacje ogólne\n\nSerwis CzyToMaSens jest dostępny pod adresem www.czytomasens.pl i umożliwia wykonanie prywatnej analizy relacji na podstawie odpowiedzi użytkownika.\n\nUsługodawcą jest osoba fizyczna prowadząca serwis CzyToMaSens. Kontakt z usługodawcą: kontakt@czytomasens.pl. Dane identyfikacyjne usługodawcy mogą zostać przekazane użytkownikowi przed dokonaniem płatności oraz w potwierdzeniu zakupu.\n\n2. Charakter usługi\n\nCzyToMaSens jest narzędziem analitycznym i refleksyjnym. Serwis nie świadczy usług psychologicznych, terapeutycznych, medycznych, prawnych ani diagnostycznych.\n\nWynik oraz raport powstają na podstawie odpowiedzi użytkownika i mają charakter informacyjny. Nie są diagnozą, opinią specjalisty ani oceną drugiej osoby.\n\n3. Korzystanie z serwisu\n\nUżytkownik wybiera ścieżkę analizy, odpowiada na pytania i może otrzymać pierwszy obraz sytuacji. Pełny raport jest dostępny po dokonaniu płatności.\n\nUżytkownik powinien udzielać odpowiedzi zgodnych z rzeczywistą sytuacją. Odpowiedzi losowe, żartobliwe, obraźliwe lub pozbawione treści mogą uniemożliwić przygotowanie rzetelnego raportu.\n\n4. Płatność i raport\n\nPełny raport jest odpłatną treścią cyfrową przygotowywaną indywidualnie na podstawie odpowiedzi użytkownika. Płatność obsługiwana jest przez Stripe. Serwis nie przechowuje pełnych danych karty płatniczej.\n\nPo skutecznej płatności rozpoczyna się przygotowanie raportu. Raport jest zwykle udostępniany niezwłocznie, jednak w przypadku opóźnień technicznych może zostać udostępniony w terminie do 14 dni. Raport może zostać wyświetlony w serwisie lub udostępniony przez link wysłany na adres e-mail.\n\n5. Prawo odstąpienia\n\nPełny raport jest treścią cyfrową niedostarczaną na nośniku materialnym. Przed zakupem użytkownik wyraża zgodę na rozpoczęcie realizacji usługi przed upływem 14 dni i przyjmuje do wiadomości, że po rozpoczęciu generowania raportu traci prawo odstąpienia od umowy w zakresie tej treści cyfrowej.\n\n6. Reklamacje\n\nReklamacje można składać na adres: kontakt@czytomasens.pl. W zgłoszeniu należy podać adres e-mail użyty przy zakupie, datę płatności oraz opis problemu.\n\nReklamacje są rozpatrywane w terminie do 14 dni. W przypadku błędu technicznego usługodawca może ponownie udostępnić raport, wygenerować go ponownie albo dokonać zwrotu płatności, jeżeli usługa nie została wykonana prawidłowo.\n\n7. Wymagania techniczne\n\nDo korzystania z serwisu wymagane są: urządzenie z dostępem do internetu, aktualna przeglądarka internetowa oraz aktywny adres e-mail, jeżeli raport ma zostać przesłany linkiem.\n\n8. Odpowiedzialność\n\nUżytkownik samodzielnie podejmuje decyzje dotyczące swojej relacji. Serwis nie ponosi odpowiedzialności za decyzje podjęte na podstawie wyniku lub raportu.\n\nW sytuacji zagrożenia życia, zdrowia, przemocy lub silnego kryzysu psychicznego użytkownik powinien skontaktować się z odpowiednimi służbami, lekarzem, psychologiem lub osobą zaufaną.\n\n9. Zmiany regulaminu\n\nUsługodawca może zmienić regulamin z ważnych powodów, w szczególności technicznych, prawnych lub organizacyjnych. Aktualna wersja regulaminu jest dostępna w serwisie.`,
  },
  prywatnosc: {
    title: "Polityka prywatności i RODO",
    body: `Data obowiązywania: 21.05.2026 r.\n\n1. Administrator danych\n\nAdministratorem danych osobowych jest osoba fizyczna prowadząca serwis CzyToMaSens. Kontakt w sprawach danych osobowych: kontakt@czytomasens.pl.\n\n2. Jakie dane przetwarzamy\n\nSerwis może przetwarzać: adres e-mail, odpowiedzi udzielone w analizie, treść wpisaną w polach otwartych, identyfikator sesji, informacje o płatności przekazane przez operatora płatności oraz podstawowe dane techniczne, takie jak adres IP, typ przeglądarki, data i godzina zdarzenia.\n\nSerwis nie wymaga podawania imienia, nazwiska, adresu zamieszkania ani danych dokumentu tożsamości w trakcie samej analizy.\n\n3. Cele przetwarzania\n\nDane są przetwarzane w celu przygotowania analizy i raportu, obsługi płatności, udostępnienia raportu, obsługi reklamacji, zapewnienia bezpieczeństwa serwisu, wypełnienia obowiązków prawnych oraz prowadzenia podstawowej analityki działania strony, jeżeli została włączona.\n\n4. Podstawy prawne\n\nPodstawą przetwarzania danych jest wykonanie umowy lub działania przed jej zawarciem, obowiązek prawny ciążący na administratorze, uzasadniony interes administratora, taki jak bezpieczeństwo serwisu i obsługa reklamacji, oraz zgoda użytkownika, jeżeli jest wymagana.\n\n5. Odbiorcy danych\n\nDane mogą być przekazywane podmiotom obsługującym serwis, w szczególności operatorowi płatności Stripe, dostawcy hostingu Railway, dostawcy poczty e-mail, dostawcy narzędzia generującego analizę oraz dostawcy analityki, jeżeli taka analityka jest używana. Dane nie są sprzedawane innym podmiotom.\n\n6. Przekazywanie danych poza EOG\n\nNiektórzy dostawcy technologiczni mogą przetwarzać dane poza Europejskim Obszarem Gospodarczym. W takim przypadku odbywa się to na podstawie odpowiednich mechanizmów prawnych, w szczególności standardowych klauzul umownych lub innych zabezpieczeń wymaganych przez RODO.\n\n7. Okres przechowywania\n\nDane związane z analizą i raportem są przechowywane przez okres do 90 dni, chyba że użytkownik wcześniej zażąda ich usunięcia albo dłuższe przechowywanie jest konieczne do obsługi reklamacji. Dane transakcyjne i dokumentacja księgowa mogą być przechowywane przez okres wymagany przepisami prawa.\n\n8. Prawa użytkownika\n\nUżytkownik ma prawo dostępu do danych, sprostowania danych, usunięcia danych, ograniczenia przetwarzania, przenoszenia danych, sprzeciwu wobec przetwarzania oraz cofnięcia zgody, jeżeli przetwarzanie odbywa się na podstawie zgody.\n\nUżytkownik ma prawo wniesienia skargi do Prezesa Urzędu Ochrony Danych Osobowych.\n\n9. Automatyczne przygotowanie raportu\n\nRaport może być przygotowywany automatycznie na podstawie odpowiedzi użytkownika. Wynik nie wywołuje skutków prawnych wobec użytkownika i nie stanowi decyzji administracyjnej, finansowej, medycznej ani prawnej.\n\n10. Dobrowolność podania danych\n\nPodanie danych jest dobrowolne, ale niezbędne do wykonania analizy, obsługi płatności i udostępnienia raportu.`,
  },
  rodo: {
    title: "Informacja RODO i cookies",
    body: `Data obowiązywania: 21.05.2026 r.\n\nAdministratorem danych jest osoba fizyczna prowadząca serwis CzyToMaSens. Kontakt w sprawach danych osobowych: kontakt@czytomasens.pl.\n\nDane są przetwarzane w celu wykonania analizy, przygotowania raportu, obsługi płatności, reklamacji, bezpieczeństwa serwisu oraz obowiązków prawnych. Użytkownik ma prawo dostępu do danych, sprostowania, usunięcia, ograniczenia przetwarzania, przenoszenia danych, sprzeciwu, cofnięcia zgody oraz złożenia skargi do Prezesa UODO.\n\nSerwis wykorzystuje pliki cookies i podobne technologie w celu prawidłowego działania strony, utrzymania sesji, zapamiętania podstawowych ustawień oraz poprawy bezpieczeństwa.\n\nJeżeli w serwisie używana jest analityka, na przykład Google Analytics lub Google Tag, mogą być stosowane cookies analityczne służące do mierzenia ruchu i sposobu korzystania ze strony.\n\nUżytkownik może ograniczyć lub usunąć cookies w ustawieniach przeglądarki. Ograniczenie cookies technicznych może spowodować, że część funkcji serwisu nie będzie działać prawidłowo.\n\nSerwis nie sprzedaje danych użytkowników.`,
  },
  kontakt: {
    title: "Kontakt",
              ...
              <section className="hero-grid">
                <Glass className="glass-panel hero-panel hero-copy">
                  ...
                  <div className="ctms-landing-actions">
                    ...
                    <div style={{ fontSize: "12px", color: BRAND.muted, marginTop: "10px" }}></div>
                  </div>
                </Glass>
            ...
            <motion.div key="consent" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
              <Glass className="question-panel consent-panel">
                ...
                <div className="consent-actions">
                  ...
                  <PrimaryButton onClick={() => { setConsents([true, true, true, true]); setStage("entry"); }}>Wchodzę dalej</PrimaryButton>
                </div>
              </Glass>
            </motion.div>
          )}
            ...
            <motion.div key={`${path.key}-open`} initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
              <Glass className="question-panel">
                ...
                <div className="question-copy">
                  ...
                  <p style={{ color: BRAND.muted, fontSize: "14px", marginTop: "10px", lineHeight: 1.65 }}>Napisz naturalnie, jak do kogoś, kto ma zobaczyć sens w chaosie. Im konkretniej opiszesz sytuację, tym trafniejszy będzie wynik.</p>
                </div>
                <textarea className="ctms-textarea" value={openText} onChange={(e) => setOpenText(e.target.value)} placeholder="Co konkretnie się dzieje? Opisz fakty, zachowania, powtarzające się sytuacje i to, czego najbardziej nie chcesz już dopowiadać sobie sam." maxLength={3000} />
              ...
              <Glass className="preview-card">
                ...
                <Glass className="unlock-panel">
                  ...
                  <div className="unlock-form">
                    <input className="ctms-input" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Twój adres e-mail. Wyślemy link do raportu" />
