...
const ENTRY_CONFIGS: EntryConfig[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      { id: "l4", lead: "Nity nie słyszy. Powiedz to wprost.", text: "Czy boisz się odejść nie dlatego że Ci jej brakuje, ale dlatego że nie wiesz kim jesteś bez tego cyklu?", options: [{ id: "a", label: "To uderza za mocno żeby zaprzeczyć.", score: 3 }, { id: "b", label: "Może trochę, ale it nie jedyny powód.", score: 2 }, { id: "c", label: "Trochę, ale głównie mi jej brakuje.", score: 1 }, { id: "d", label: "Nie. Boję się bo mi jej brakuje, nie dlatego.", score: 0 }] },
      ...
      <footer className="ctms-footer">
        <div className="ctms-footer-inner">
          ...
          <div className="ctms-footer-links">
            ...
            <button onClick={() => setLegalOpen("kontakt")}>Contact</button>
          </div>
        </div>
      </footer>
