            ...
            <motion.div key="consent" initial={{ opacity: 0, y: 16 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0 }}>
              <Glass className="question-panel consent-panel">
                ...
                <div className="consent-note">
                  Korzystając dalej, potwierdzasz, że zapoznałeś się z Regulaminem i Polityką prywatności. Pełny raport jest treścią cyfrową przygotowywaną po płatności na podstawie Twoich odpowiedzi.
                </div>
